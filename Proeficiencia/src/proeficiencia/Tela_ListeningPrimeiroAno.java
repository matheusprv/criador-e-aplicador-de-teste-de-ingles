 ...
 * @author matheus
 */
public class Tela_ListeningPrimeiroAno extends javax.swing.JFrame {
    ...
    //String salvamento_do_aluno[]= new String[6];// Para obter o que o aluno ja havia marcado
    
    public Tela_ListeningPrimeiroAno() {
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            Logger.getLogger(Tela_ListeningPrimeiroAno.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void salvar_conclusao(){
        String terminou="terminou";
        File arquivo_bloqueio=new File("Terminou_o_listening.txt");
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_ListeningPrimeiroAno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_ListeningPrimeiroAno().setVisible(true);
            }
        });
    }
